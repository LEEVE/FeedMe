    ...
    return this.each(function(){
        ...
        function buildNavButtons() {
            if ( settings.enableNavButtons && _flipItems.length > 1 ) {
                ...
                _flipster.append("<br/><a href='#' class='flipto-prev btn btn-primary col-lg-3 col-lg-offset-3'>"+settings.prevText+"</a> <a href='#' class='flipto-next btn btn-primary col-lg-3'>"+settings.nextText+"</a>");
